      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-3">
        ...
        >
          ...
          <div class="space-y-2">
            ...
            <button
              @click="$emit('importScreenshot')"
              class="w-full px-3 py-2 bg-state-warning hover:bg-state-warning/90 text-white rounded text-sm font-medium transition-colors flex items-center gap-2"
            >
              <svg
                class="w-4 h-4"
                fill="none"
